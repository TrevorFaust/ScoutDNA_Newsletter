...
RAW_ROWS: list[tuple[str, str, str, str, str, str]] = [
    ...
    ("ATL", "QB", "QB1", "contested", "Michael Penix Jr.|Tua Tagovailoa", "Key QB camp battle"),
    ...
    ("CHI", "RB", "RB1", "contested", "D'Andre Swift|Kyle Monangai", "Split backfield possible"),
    ...
    ("CLE", "QB", "QB1", "open", "Deshaun Watson|Shedeur Sanders", "Main starter battle"),
    ...
    ("GB", "RB", "RB1", "contested", "Josh Jacobs|Chris Brooks|MarShawn Lloyd", "Jacobs legal trouble; vet add possible"),
    ...
    ("HOU", "WR", "WR2", "settled", "Jayden Higgins", "Likely WR2"),
    ("HOU", "WR", "WR3", "contested", "Tank Dell|Jaylin Noel|Xavier Hutchinson", "WR3 battle"),
    ("HOU", "RB", "RB1", "contested", "David Montgomery|Woody Marks", "Montgomery vs Marks"),
    ("HOU", "TE", "TE1", "settled", "Dalton Schultz", "Clear TE1"),
    ("IND", "QB", "QB1", "contested", "Daniel Jones|Anthony Richardson Sr.", "Jones lean; Richardson upside"),
    ...
    ("JAX", "WR", "WR1", "open", "Brian Thomas Jr.|Jakobi Meyers|Travis Hunter", "Three WR1 options; Hunter snap-limited"),
    ("JAX", "WR", "WR2", "contested", "Parker Washington", "Washington fights for WR2/WR3 after WR1 fallout"),
    ...
    ("LV", "RB", "RB1", "settled", "Ashton Jeanty", "Clear RB1"),
    ("LV", "RB", "RB2", "contested", "Ashton Jeanty|Mike Washington Jr.", "Split-backfield watch"),
    ...
    ("MIA", "QB", "QB1", "contested", "Malik Willis|Quinn Ewers", "Willis named starter"),
    ...
    ("NE", "WR", "WR2", "contested", "Romeo Doubs|Kayshon Boutte", "Boutte may push Doubs"),
    ...
    ("NO", "WR", "WR1", "contested", "Chris Olave|Jordyn Tyson", "Tyson 1st round"),
    ...
    ("PHI", "WR", "WR1", "contested", "DeVonta Smith|Makai Lemon", "Brown gone; Lemon may push"),
    ...
    ("SF", "WR", "WR1", "contested", "Mike Evans|Ricky Pearsall|De'Zhaun Stribling", "Evans if healthy; injury watch"),
    ...
    ("SEA", "RB", "RB1", "contested", "Zach Charbonnet|Jadarian Price", "Price 1st round vs Charbonnet"),
    ...
    ("TB", "RB", "RB1", "settled", "Bucky Irving", "Gainwell RB2"),
    ("TB", "RB", "RB2", "settled", "Kenneth Gainwell", "Committee backup"),
    ...
    ("WAS", "WR", "WR2", "contested", "Luke McCaffrey|Antonio Williams", "Williams rookie push"),
    ("WAS", "WR", "WR3", "open", "Jaylin Lane", "WR3 pool after WR2 fallout"),
